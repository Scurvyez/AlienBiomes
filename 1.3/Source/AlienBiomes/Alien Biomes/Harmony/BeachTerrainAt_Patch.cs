...
namespace AlienBiomes
{
    ...
    public static class BeachTerrainAt_Patch
    {
        ...
        {
            if (__result == TerrainDefOf.Sand && biome.defName == "SZ_RadiantPlains" && AlienBiomesSettings.AllowReplacingOfSand == true)
            ...
            if (__result == TerrainDefOf.Sand && biome.defName == "SZ_CrystallineFlats" && AlienBiomesSettings.AllowReplacingOfSand == true)
            {
